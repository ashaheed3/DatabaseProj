...
public class CustomerInfoController {
	...
	public void SubmitClicked(){
		...
		String inputQuery = "INSERT INTO Customer (first_name, last_name, email, phone_number, address, city, zip, state, country, username, passw)" + "values (?,?,?,?,?,?,?,?,?,?,?)";
		try {
